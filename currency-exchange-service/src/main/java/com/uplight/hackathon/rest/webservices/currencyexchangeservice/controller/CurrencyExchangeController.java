...
public class CurrencyExchangeController {
    ...
    public CurrencyExchange retrieveExchangeValue( @PathVariable String from, @PathVariable String to, @RequestHeader Map<String, String> headers ) {
        CurrencyExchange currencyExchange1 = currencyExchangeRepository.findByFromAndTo( from, to );

        System.out.println( "headers in retrieveExchangeValue are " + headers );
